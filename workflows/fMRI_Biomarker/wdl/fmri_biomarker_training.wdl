workflow wf_fmri_biomarker_training {
    File trainData
    File testData
    File monitorScript
...
task merge {
    ...
    command {
        ...
        rm -rf trainedModelData.tar.gz trainedSavedResults.tar.gz  || echo "Failed: rm -rf trainedModelData.tar.gz trainedSavedResults.tar.gz"
        echo "ls -alt"
        ls -alt
        cd -
