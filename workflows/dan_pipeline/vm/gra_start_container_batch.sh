...
REMOTE_USER=pgu6
REMOTE_HOST_IP=csic.som.emory.edu
REMOTE_TASK_RECEIVING_DIR=/home/pgu6/synergy_process/DATA_FROM_BMI
...
function push_output() {
    ...
    cd -
    echo "scp ${OUTPUT_DIR}/${data_in_folder_name}_outputs.zip ${REMOTE_USER}@${REMOTE_HOST_IP}:${REMOTE_TASK_RECEIVING_DIR}/"
    scp ${OUTPUT_DIR}/${data_in_folder_name}_outputs.zip ${REMOTE_USER}@${REMOTE_HOST_IP}:${REMOTE_TASK_RECEIVING_DIR}/
}
